  ...
  /* * * * * * * * * * * * * * * * * * *
	...
	*/
	Ad.loadedListener.start = function(){
		Ad.loadedListener.log("Ad.loadedListener.start");

		if (Ad.config.onloadFired == true){
			Ad.loadedListener.log("Injecting child now");
	...
	*/
	Ad.loadedListener.traceTime = function(){
		...
		Ad.loadedListener.log(Ad.loadedListener.curTime);
	...
	*/
	if (!Enabler.isInitialized()) {
		Ad.loadedListener.log("Adding initialiser event listener");
		Enabler.addEventListener(studio.events.StudioEvent.INIT, Ad.loadedListener.start);
	}
	else {
		Ad.loadedListener.log("Enabler initialised. Starting ad");
