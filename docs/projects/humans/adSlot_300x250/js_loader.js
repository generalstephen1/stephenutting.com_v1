...
function setUpLoader(){
	...
	//append 12 stalk elements into the preloader container
	for (var i=0; i<12; i++){
		var stalk = document.createElement('div');
		stalk.className = "preloader-stalk";
		Ad.loader.container.appendChild(stalk);
	}
	//then grab references to them all
